...
<c:if test="${not empty sessionScope.SESSION_USER}"><c:redirect url="${basePath}" /></c:if>
...
<div class="ym-wrapper"><div class="ym-wbox">
	...
	<div style="width: 500px; margin: 0 auto;">
		<form method="post" action="${basePath}" onsubmit="return doSubmit();" class="ym-form ym-full">
			...
			<h6 class="ym-fbox-heading">智慧家居管理平台</h6>
			...
			<div class="ym-fbox-footer">
				<div><button type="submit" class="ym-button" id="ok">登录</button></div>
