...
public class Util {
	...
	// 用户认证图片存放目录
	public static final String LICENSE_IMAGES = "/usr/local/xinxinke/license_images";
	public static final String DOWNLOAD = "/usr/local/xinxinke/export/mt";
	//public static final String DOWNLOAD = "C:/Users/Administrator/Desktop/file";
	...
	public static Map<String, String> loadProperties(InputStream inStream) throws IOException {
		Map<String, String> map = new HashMap<String, String>();
		Properties p = new Properties();
		p.load(inStream);
		for (String i : p.stringPropertyNames()) {
			map.put(i, p.getProperty(i));
		}
		return map;
	}
}
